    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6" align="center">
                <p>시작날짜 : <input type="text" class="datepicker2" id = "startdate"></p>
                <p> ~ </p>
                <p>종료날짜 : <input type="text" class="datepicker2" id = "enddate"></p>
               ...
               <option class="form-control mr-sm-2" value="design">서점</option>
                ...
                <p>지역 : <input type="text" id = "location"> <input type="text" id = "location2">
                <p><button class="btn btn-primary my-2 my-sm-0" type="button" id="search">검색</button>
